...
MOCK_EVIDENCE = [
    ...
    {
        "title": "Workspace productivity platform website",
        "url": "https://example.com/workspace-productivity-platform",
        "snippet": "The company describes a connected workspace for docs, wikis, project tracking, internal knowledge management, and team collaboration.",
        "query": "workspace productivity platform connected workspace docs wiki project management company website",
        "evidence_type": "website",
        "confidence": 0.82,
    },
    {
        "title": "Workspace productivity software market overview",
        "url": "https://example.com/workspace-productivity-market",
        "snippet": "Knowledge-work teams are consolidating docs, wikis, project tracking, AI search, and collaboration workflows into workspace productivity platforms.",
        "query": "workspace productivity software market connected workspace knowledge management collaboration",
        "evidence_type": "market",
        "confidence": 0.72,
    },
    {
        "title": "Workspace productivity competitive landscape",
        "url": "https://example.com/workspace-productivity-competitors",
        "snippet": "Workspace productivity platforms compete with Microsoft 365, Google Workspace, Coda, Confluence, Asana, ClickUp, Monday.com, Airtable, Smartsheet, and manual docs plus spreadsheets plus Slack or email workflows.",
        "query": "workspace productivity platform competitors Microsoft 365 Google Workspace Coda Confluence Asana ClickUp Airtable Smartsheet",
        "evidence_type": "competitor",
        "confidence": 0.74,
    },
    {
        "title": "Workspace productivity enterprise expansion and AI roadmap news",
        "url": "https://example.com/workspace-productivity-enterprise-ai",
        "snippet": "Workspace platforms are expanding enterprise administration, permissions, AI-native knowledge work, and collaboration capabilities for larger teams.",
        "query": "workspace productivity enterprise expansion AI roadmap retention news",
        "evidence_type": "news",
        "confidence": 0.68,
    },
    {
        "title": "Workspace productivity pricing and enterprise plans",
        "url": "https://example.com/workspace-productivity-pricing",
        "snippet": "Workspace productivity software commonly uses seat-based team and enterprise plans with admin controls, security, collaboration, AI features, and retention-focused expansion.",
        "query": "workspace productivity pricing enterprise plans business model",
        "evidence_type": "business_model",
        "confidence": 0.66,
    },
]
